...
# venn.R
#
# This file handles putting together summary data for all outcomes across all
# data sources for the replicated Covid-19 x Cardiovascular paper
# Original text: https://doi.org/10.1038/s41467-024-46497-0
#
# Arguments:
#  - cohort - string, specifies which study cohort is being processed
#             (prevax, vax, unvax)
#  - analyses - string, specifies which of the active analyses to look at
#               (e.g. main, covid hospitalisation)
#
# Returns:
#  - venn data table:
#    (output/venn/venn-cohort_<cohort>.csv)
#  - venn data table, rounded:
#    (output/venn/venn-cohort_<cohort>-midpoint6.csv)
#
