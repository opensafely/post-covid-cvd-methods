...
# table2.R
#
# This file generates the "outcome frequencies" table
...
#    (output/table2/table2-cohort_prevax-midpoint6.csv)
#  - The outcome frequencies data table
#    (output/table2/table2-cohort_prevax.csv)
#
